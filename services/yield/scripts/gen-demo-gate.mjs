...
const samplePath = resolve(arg("sample", join(samples, "gauge-emissions-2026-09-05-composite.json")));
const modelPath = resolve(arg("model", join(samples, "lp-model-2026-09-05.json")));
