...
// "t1KrbA8XLcmZUsSdcXhkpKUWX5rMctSH5dP", createdAt 1722900000, active true
const POS_FIXTURE =
  "";
...
describe("RpcReadOnlyChainService", () => {
  it("decodes getPosition including nested params and dynamic string", async () => {
    ...
    assert.equal(p.zcashAddress, "t1KrbA8XLcmZUsSdcXhkpKUWX5rMctSH5dP");
