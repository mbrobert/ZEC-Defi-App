...
|---|---|---|
| Contracts (Foundry) | `cd contracts && forge test` | **464 passed / 0 failed / 13 skipped** (477 total), 41 suites (re-measured 2026-09-26: the perps rail's Base half, +9) |
...
| Root ABI seam | `node scripts/verify-abi.mjs` | **542** selectors / topics / errors across 20 contracts (2026-09-26: the router's perps pair; 2026-09-25: `HyperliquidPerpVenue` added) |
| Shared | `npm test -w @zyo/shared` | **160** (2026-09-25: 19 perps tests) |
