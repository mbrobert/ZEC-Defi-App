> **History.** Internal review ledger of the pre-pivot design (PositionVault / RewardRouter / SnuggleAdapter, NEAR-Intents payout leg), rounds of 2026-08-06. None of that code exists in the tree any more (`BASE-PIVOT-2026-09.md`); the engine facts recorded here (60-second hold, 15 % engine fee, harvest vs claimStakingRewards, referral lock) still hold and carried into `SnuggleLpVenue`. Current audit surface: `AUDIT.md`, `AUDIT-SCOPE.md`.
