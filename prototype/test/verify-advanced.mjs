...
{
  await page.evaluate(() => { const o = window.__oil; o.dispatch({ type: "wiz", key: "mode", value: "LP" }); o.dispatch({ type: "wiz", key: "asset", value: "cbBTC" }); o.dispatch({ type: "wiz", key: "amount", value: 0.25 }); o.dispatch({ type: "wiz", key: "ltv", value: 40 }); o.dispatch({ type: "wiz", key: "pool", value: "aero-cbbtc-usdc" }); o.dispatch({ type: "wiz", key: "preset", value: "CONSERVATIVE" }); o.dispatch({ type: "wiz", key: "ack", value: true }); o.dispatch({ type: "beginFlow" }); const id = o.S.flow.id; for (let i = 0; i < 7; i++) o.dispatch({ type: "flowAdvance", id }); o.dispatch({ type: "flowComplete", id }); o.dispatch({ type: "flowDismiss" }); });
