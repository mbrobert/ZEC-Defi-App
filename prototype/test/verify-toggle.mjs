...
vm.runInContext(block(simple) + "\nthis.OUT = { OIL_SHARED, OIL_CHAIN_READ, OIL_MODEL, OIL_CONTRACTS, mcLpNetPct, mcApply, minOutFor, swapLegFor, GATE_WHY, realizedEmissionsPct, grossIfRevotedPct, maxOfferedLtvBps, maxOfferedLtvStopBps, ltvPresetsFor, entryHf, dropPct, halfWidthPct, gate, forecast, forecastWhy, FORECAST_SAFETY, lpNetPct, positionAprPct, presetWidthBps, classifyCbZecAddress, topLtvPct, ltvStopsFor, LAD, RUNGS };", sandbox);
const P = sandbox.OUT;
