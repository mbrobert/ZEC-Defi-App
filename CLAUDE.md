...
the repayment never move; only the borrowed USDC may cross, by CCTP, to be
deployed on the other chain (D6). Shared across chains: the ladder, the slider
...
(prose only — it carries no counts and no dated readings), `docs/STATUS.md`
(generated by `npm run status`: every suite's count, what is deployed, the
forecast verdict, the audit history, the index of `docs/`), `SETUP.md`,
`docs/DIRECTION-2026-09-11.md`, `docs/CROSSCHAIN-LOOP-2026-09-12.md`,
